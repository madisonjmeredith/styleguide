...
class UpdateStyleGuideRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'configuration.buttonFont' => ['sometimes', 'string', 'max:100'],
            'configuration.buttonFontMeta' => ['sometimes', 'array'],
            'configuration.buttonFontMeta.category' => ['required_with:configuration.buttonFontMeta', 'string', 'max:50'],
            'configuration.buttonFontMeta.weights' => ['required_with:configuration.buttonFontMeta', 'string', 'max:100'],
            'configuration.buttonFontWeight' => ['sometimes', 'integer', 'in:300,400,500,600,700,800,900'],
            'configuration.buttonLetterSpacing' => ['sometimes', 'string', 'in:tight,normal,wide'],
